...
<div class="flex h-screen">
        ...
        <div>
            ...
            <nav class="px-6 py-4 space-y-2">
                ...
                <a href="{{ route('menu.index') }}"
                    class="block py-2 px-4 rounded font-medium {{ request()->routeIs('menu.create_menu') ? 'bg-blue-100 text-blue-800' : 'hover:bg-gray-100 text-gray-700' }}">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Agregar plato/s al menú del día</h1>

        <!-- Tabla de Pedidos -->
        <div class="container mx-auto p-6" x-data="menuForm()">
